    ...
    <div>
      ...
      <Container>
        <Routes>
          ...
          <Route path='/butcher/beef' element={<Beef items={items} />} />
          <Route path='/butcher/pork' element={<Pork items={items} />} />
          <Route path='/butcher/poultry' element={<Poultry items={items} />} />
          <Route path='/butcher/lamb' element={<Lamb items={items} />} />
          <Route path='/butcher/seafood' element={<Seafood items={items} />} />
          ...
          if (user) {<Route path='/butcher/profile' element={<ProfilePage user={user} setUser={setUser}/>} />}
