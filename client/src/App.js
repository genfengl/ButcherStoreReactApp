  ...
  return (
    <div>
      <CartProvider>
        ...
        <Container>
          <Routes>
            <Route path="/" element={<Navigate replace to="/butcher" />} />
            <Route
              path="/butcher"
            ...
            <Route
              path="/butcher/beef"
              element={<Beef items={items} user={user} />}
            />
            <Route
              path="/butcher/pork"
              element={<Pork items={items} user={user} />}
            />
            <Route
              path="/butcher/poultry"
              element={<Poultry items={items} user={user} />}
            />
            <Route
              path="/butcher/lamb"
              element={<Lamb items={items} user={user} />}
            />
            <Route
              path="/butcher/seafood"
              element={<Seafood items={items} user={user} />}
            />
            <Route path="/butcher/:id" element={<Show user={user} />} />
            <Route path="/butcher/search" element={<Search />} />
            <Route
              path="/butcher/edit/:id"
            ...
            <Route
              path="/butcher/add"
              element={
                items.length && <CreateMeat items={items} setItems={setItems} />
              }
            />
            if (user){" "}
            {
            ...
            <Route
              path="/butcher/success"
              element={<SuccessPage user={user} />}
            />
          </Routes>
          {/* <Redirect from="*" to="/butcher" /> */}
        </Container>
      </CartProvider>
    </div>
  );
